...
bool RectangularCollisionStrategy::execute(
      const TwoWayMultiSprite& sprite1, const TwoWayMultiSprite& sprite2) const {
...
bool PerPixelCollisionStrategy::execute(
      const TwoWayMultiSprite& obj1, const TwoWayMultiSprite& obj2) const {

  RectangularCollisionStrategy strategy;
  if ( not strategy.execute(obj1, obj2) ) return false;
  if (obj1.getCurrentChannel() != obj2.getCurrentChannel()) return false;
