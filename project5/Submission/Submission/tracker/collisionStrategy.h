...
public:
  virtual bool execute(const TwoWayMultiSprite&, const TwoWayMultiSprite&) const = 0;
...
public:
  ...
  virtual bool execute(const TwoWayMultiSprite&, const TwoWayMultiSprite&) const;
